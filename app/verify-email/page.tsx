...
export default function VerifyEmailPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0A1628', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 420, backgroundColor: '#0F1F35', border: '1px solid rgba(0,206,201,0.2)', borderRadius: 20, padding: 40, textAlign: 'center' }}>
        <div style={{ height: 4, background: 'linear-gradient(to right, #00CEC9, #00B894)', borderRadius: '20px 20px 0 0', margin: '-40px -40px 32px' }} />
        {status === 'loading' && (
          <>
